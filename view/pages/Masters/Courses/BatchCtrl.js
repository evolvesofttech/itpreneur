...
controller("batchCtrl", 
    ...
    /*========================================
     ...
     =            From Date Change            =
     ========================================*/
     $scope.fromDateChange = function(dat) {
    ...
    ======================================*/
    //1 Mean New Entry
    var urlList = baseUrlSrvc.baseUrl + 'listBatchByCourseId/'+ $scope.OperType;
    ...
    $scope.viewBatch = function(id, bdata) {
       ...
       $scope.viewbatchData= {
          ...
          "fromdate": $scope.temp_var_a[0].fromdate,
          "todate": $scope.temp_var_a[0].todate,
          "fromtime": $scope.temp_var_a[0].fromtime,
          "totime": $scope.temp_var_a[0].totime,
