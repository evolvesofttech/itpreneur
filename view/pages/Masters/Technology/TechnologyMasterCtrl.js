...
controller("technologyCtrl", 
    ...
    $window.document.title = "ITPreneur - Technology";
    ...
    $scope.viewtechnology = function(id, bdata) {
        //console.log(id); 
        $scope.temp_var_a = $filter('filter')(bdata, { "cTechnologyMasterId": id });

       $scope.viewtechnologyData= {
          "cTechnologyMasterId": $scope.temp_var_a[0].cTechnologyMasterId,
