...
controller("ExecutivewiseSalesActivityCtrl", 
    ...
    $scope.branchArray = [];
    $window.document.title = "ITPreneur - Executivewise Sales Activity Reports";
   ...
   $scope.branchChange = function(id, branchdata) {
    ...
    //} else {
        ...
        var urlExeList = baseUrlSrvc.baseUrl + 'listExecutivewiseActivitySalesReportUsersByBranchId/' + id;
   ...
   $scope.generateReport = function(data) {
        ...
        var FormData = {
            ...
            url: baseUrlSrvc.baseUrl + 'listExecutivewiseActivitySalesReport'
        };
        ...
        promisePut.then(function (pl) {
            ...
            //console.log("ExecutivewisePlacementActivityData",$scope.ExecutivewisePlacementActivityData);
