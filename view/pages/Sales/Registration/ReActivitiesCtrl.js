...
=========================================*/
angular.module('theGuru').controller("registrationactivitiesCtrl", function($rootScope, $scope, $log, 
    $routeParams, 
  $route,CRUD_SERVICE, baseUrlSrvc, $filter, $sessionStorage, 
  $timeout, ngTableParams, Flash, inst_id, toaster, 
  firstNameService, middleNameService, lastNameService, Branch_Id) {
    ...
    $scope.saveActivities = function (data) {
        ...
        if (data.acActivityId) {
            ...
            data.activityagainst = "Application";
