...
controller("QualificationCtrl", 
    function ($scope, $log, $routeParams, $http, CRUD_SERVICE, baseUrlSrvc,
        ngTableParams,$filter, ngTableDataService, $timeout, $route, Branch_Id, 
        Flash,$rootScope, $sessionStorage, toaster,  
        firstNameService, middleNameService, lastNameService) {
    //console.log("source");
    ...
    ============================================*/
    $scope.clearModalOnCloseQualification = function() {
        $scope.enquiryQualificationData = {};
        $scope.enquirygapData = {};
    }
